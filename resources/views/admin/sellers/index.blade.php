...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-7 align-self-center">
            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Data Penjual</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item"><a href="#" class="text-muted">Dashboard</a></li>
                        <li class="breadcrumb-item text-muted active" aria-current="page">Manajemen Penjual</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">
                        <a href="{{ route('sellers.create') }}" class="btn btn btn-rounded btn-primary">Tambah Penjual Baru</a>
                    </h4>
                            ...
                            <tbody>
                                @foreach ($sellers as $item)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href="{{ route('sellers.edit', $item->id) }}" class="btn btn-sm btn btn-rounded btn-primary"><i class="fas fa-edit"></i></a>&nbsp;
